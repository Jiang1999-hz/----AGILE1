...
Use the manifest as the working document for question-by-question rewriting, then mark approved rows as `ready_for_import` and export them into JSON for the database seed/import pipeline.
